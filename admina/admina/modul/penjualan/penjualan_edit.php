            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <form id="input" method="post" class="form-horizontal foto_banyak"
                        action="<?= base_admin() ?>modul/penjualan/penjualan_action.php?act=up">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value='<?= $data_edit->tgl ?>' class="form-control pull-right"
                                        id="tgl_booking" name="tgl_booking" id="datepicker">
                                </div>
                            </div>
                        </div><!-- /.form-group -->
