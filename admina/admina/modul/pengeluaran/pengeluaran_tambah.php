            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <form id="input" method="post" class="form-horizontal"
                        action="<?= base_admin() ?>modul/pengeluaran/pengeluaran_action.php?act=ini">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-4">
                                <input type="text" id="level" name="nama_p" placeholder="Pengeluaran dana"
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-4">
                                <input type="text" id="gapok" name="keterangan" placeholder="Keterangan"
                                    class="form-control " required>
                                <input type="hidden" id="gapok" name="status_p" value='1' class="form-control ">
                                <input type="hidden" id="gapok" name="status" value='A' class="form-control ">
                            </div>
                        </div><!-- /.form-group -->
