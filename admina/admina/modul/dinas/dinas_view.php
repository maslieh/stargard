...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= base_index() ?>dinas">dinas </a></li>
        <li class="active">dinas List</li>
    </ol>
</section>
<?php
                    ...
                    <table id="dtb_manual" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            if ($dat->level == 'administrator') {
                                $dtb = $db->query(
                                    "select *, a.id as id,b.id as idu from t_pengeluaran  as a,sys_users as b where a.nama_peminjam=b.id and pengajuan='D' and sts_hapus='N' "
                                );
                            } elseif ($dat->level == 'admin') {
                                $dtb = $db->query(
                                    "select *, a.id as idp from t_pengeluaran  as a,sys_users as b where a.nama_peminjam=b.id and pengajuan='D' and sts_hapus='N'"
                                );
                            } else {
                                $dtb = $db->query(
                                    "select *, a.id as id,b.id as idu from t_pengeluaran  as a,sys_users as b where a.nama_peminjam=b.id and a.nama_peminjam ='$ids' and pengajuan='D' and sts_hapus='N'"
                                );
                            }
                            $no = 1;
                            foreach ($dtb as $isi) {
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">EDIT dinas</h4>
                                                <div class="modal-body">
                                                    <div class="box-body">
                                                        <form id="update" method="post" class="form-horizontal"
                                                            action="<?= base_admin() ?>modul/dinas/dinas_action.php?act=up">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="box-body">
                                                        <form id="update" method="post" class="form-horizontal"
                                                            action="<?= base_admin() ?>modul/dinas/dinas_action.php?act=del">
                                                            <div class="form-group">
                                                                <label for="First Name" class="control-label">
...
<div class="modal fade" id="modal-tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form id="input" method="post" class="form-horizontal"
        action="<?= base_admin() ?>modul/dinas/dinas_action.php?act=in">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">dinas </h4>
                    <div class="modal-body">
                        <div class="box-body">
                            <h3>Input Data</h3> <label for="Level User" class="control-label"> Untuk</label>
                            <div class="form-group">

                                <div class="col-lg-12">
                                    <select name="nama_p" required data-placeholder="Pilih ..."
                                        class="form-control pull-right" tabindex="2">
                                        <option value="">Pilih</option>
                                        <?php foreach (
                                            $db->query(
                                                "select * from t_pengajuan where kode ='D' "
                                            )
                                            as $isi
                                        ) {
                            ...
                            <label for="Level User" class="control-label">Tanggal dinas</label>
                            <input type="text" class="form-control pull-right date" name="tanggal"
                                value="<?= date('Y-m-d') ?>" id=""><br />
                            <label for="Level User" class="control-label">Jam mulai dinas</label>
                            <input type="time" class="form-control pull-right" required plscholder="1000000"
                                name="mulai" id=""><br />
                            <label for="Level User" class="control-label">Jam akhir dinas</label>
                            <input type="time" class="form-control pull-right" required plscholder="1000000"
                                name="akhir" id=""><br />
                            <input type="hidden" class="form-control pull-right" value='30000' required
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <select name="nama_peminjam" required data-placeholder="Pilih  ..."
                                        class="form-control pull-right" tabindex="2">
                                        <option value="">Pilih </option>
                                        <?php foreach (
                                            $db->query(
