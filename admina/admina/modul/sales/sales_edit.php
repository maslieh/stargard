        ...
        <div class="col-lg-12">
            <div class="box box-solid box-primary">
                <div class="box-header">
                    <h3 class="box-title">EditData sales</h3>
                ...
                <div class="box-body">
                    <form id="update" method="post" class="form-horizontal"
                        action="<?= base_admin() ?>modul/sales/sales_action.php?act=up">
                        ...
                        <div class="form-group">
                            <label for="Group User" class="control-label col-lg-2">Level User</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" id="dealer" name="dealer" value="<?= $data_edit->dealer ?>"
                                    placeholder="Honda Cibubur" class="form-control">
                            </div>
                        </div><!-- /.form-group -->
