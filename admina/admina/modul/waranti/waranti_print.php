...
<div class="box-body" onload="window.print();">
    <section class="invoice">
        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                <table class="table table-striped" style="border-style: dotted;">
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <tbody>
                        ...
                        $dtb = $db->query(
                            "select t_history.keterangan,t_history.waranti,t_history.harga_w,t_history.tgl_pakai,t_history.pekerjaan,
