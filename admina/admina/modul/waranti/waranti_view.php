                    ...
                    <form action="<?= base_index() ?>waranti/cari" method="get" class="form_cari">
                        <div class="input-group col-lg-6">
                            <span class="input-group-btn">
                                <button class="btn btn-default" disabled type="button">cari berdasarkan </button>
                            </span>
                            <input type="text" name="mulai" class="form-control date" placeholder="yyyy-mm-dd" />
                            <span class="input-group-btn">
                                <button class="btn btn-default" disabled type="button"> s/d </button>
                            </span>
                        ...
                        <tbody>
                            ...
                            <tr id="line_<?= $isi->id ?>">
                                ...
                                <td width="220">
                                    ...
                                    <a href="waranti/print/<?= $isi->waranti ?>" class="btn btn-sm bg-blue badge">
                    ...
                    <form action="<?= base_index() ?>waranti/cari" method="get" class="form_cari">
                        ...
                        <div class="form-row col-md-12">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="mli" class="form-control date" placeholder="yyyy-mm-dd" />
                            </div>
                            <div class="form-group col-md-3">
                                <label for="inputCity">Sampai</label>
                                <input type="text" name="smp" class="form-control date" placeholder="yyyy-mm-dd" />
                            </div>
                ...
                <div class="box-body table-responsive">
                    <table id="dtb_manual" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            from t_transaksi as a, t_history as b where a.waranti=b.waranti order by b.status_bayar DESC
                            "
                            );
