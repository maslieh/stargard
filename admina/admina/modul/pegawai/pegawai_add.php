            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    ...
                    <form id="input_user" method="post" class="form-horizontal"
                        action="<?= base_admin() ?>modul/pegawai/pegawai_action.php?act=in">
                        ...
                        <div class="form-group">
                            <label for="Username" class="control-label col-lg-2">Uang Makan</label>
                            <div class="col-lg-10">
                                <input type="text" id="uang_makan" name="uang_makan" placeholder="50000"
                                    class="form-control">
                            </div>
                        </div><!-- /.form-group -->
                        <div class="form-group">
                            <label for="Username" class="control-label col-lg-2">Jatah Cuti</label>
                            <div class="col-lg-10">
                                <input type="text" id="jatah" name="jatah" placeholder="12" class="form-control">
                            </div>
                        </div><!-- /.form-group -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" id="norek" name="norek" placeholder="norek"
                                    class="form-control">
                            </div>
                        </div><!-- /.form-group -->
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select name="id_group" data-placeholder="Pilih Group User ..."
                                    ...
                                    <?php foreach (
                                        $db->query(
                                            "select * from sys_group_users where id !='1' "
                                        )
                                        as $isi
                                    ) {
