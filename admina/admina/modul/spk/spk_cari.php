                ...
                <div class="box-header">
                    ...
                    <form action="<?= base_index() ?>spk/cari" method="get" class="form_cari">
                        <div class="input-group col-lg-6">
                            ...
                            <input type="text" name="mulai" value="<?= $mulai ?>" class="form-control date"
                                placeholder="yyyy-mm-dd" />
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button"> s/d </button>
                            </span>
                            <input type="text" name="dari" value="<?= $mulai ?>" class="form-control date"
                                placeholder="yyyy-mm-dd" />
                    ...
                    <table id="dtb_manual" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            if (
                                ...
                                $dtb = $db->query(
                                    "SELECT p.tek1,p.tek2,p.waranti,p.tek3,p.tek4, p.id,p.tgl,p.tgl_server,p.no_rangka, p.nama,p.waranti,p.alamat,p.tlp,p.jns_kendaraan,p.no_polisi,t.harga,p.diskon,p.total_b
                                 FROM `t_transaksi` as p, t_paket as t, t_tipe as e where p.id_teknisi=t.id and t.tipe=e.id 
                                 and p.sts_book='Y' AND sts_hapus='N'and p.tgl BETWEEN '$mulai'and'$dari'                                
                                  order by 
                                 p.tgl DESC; "
                                );
                            } else {
                            ...
                            foreach ($dtb as $isi) {
                               ...
                               <label> ' .
                                ...
                                <label> ' .
                                    ...
                                    if ($teknisi4) {
                                        $idm4 = $isi->tek4;
                                        $datsa4 = $db->fetch_custom_single(
                                            "select*from sys_users where id='$idm4' "
                                        );
                                        $cet4 =
                                            '<a href="print/' .
                                            $isi->waranti .
