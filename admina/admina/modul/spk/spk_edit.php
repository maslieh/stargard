            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <form id="input" method="post" class="form-horizontal foto_banyak"
                        action="<?= base_admin() ?>modul/spk/spk_action.php?act=up">
                                ...
                                <select name="id_paket" data-placeholder="Pilih Paket Services ..."
                                    ...
                                    <?php foreach (
                                        ...
                                        if (
                                            ...
                                            echo "<option value='$isi->idp' selected>$isi->nama - $isi->tipe (Rp. $isi->harga)</option>";
                                        } else {
                                            echo "<option value='$isi->idp'>$isi->nama - $isi->tipe (Rp. $isi->harga)</option>";
                                        }
                                    } ?>
                                </select>
                            </div>
