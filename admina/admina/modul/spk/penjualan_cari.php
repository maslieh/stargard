        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <a href="<?= base_index() ?>spk/tambah" class="btn btn-primary"><i class="fa fa-plus"></i>
                        ...
                        <tbody>
                            ...
                            $dtb = $db->query(
                                ...
                                and p.tgl BETWEEN '$mulai' and '$dari'
                                 and p.sts_book='Y' AND sts_hapus='N' order by waranti DESC; "
                            );
                            $no = 1;
