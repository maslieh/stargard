        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <form action="<?= base_index() ?>bayargaji/cari" method="get" class="form_cari">
                        <div class="input-group col-lg-6">
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button">PERIODE PENGGAJIAN </button>
                            </span>
                        ...
                        <small>Pilih periode tanggal gaji dahulu jika ingin menghitung gaji</small>
                    </form>
                    <hr />
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($dtb as $isi) {
                                ...
                                $date2 = date('Y-m-27');
                                $abs = $db->query(
                                    "Select * from t_presensi where id_pegawai='$idpp' and status='M' and tanggal BETWEEN '$mulai' AND '$dari'"
                                );
                                ...
                                $telat = $db->query(
                                    "Select * from t_presensi where id_pegawai='$idpp' and status='M' and tanggal BETWEEN '$mulai' AND '$dari'  and waktu >'$bats' "
                                );
                                ...
                                $lembur = $db->fetch_custom_single(
                                    "Select count(nama_peminjam) as jumlah from  t_pengeluaran where nama_peminjam='$idpp' and pengajuan='L' and status_aju='Y'  and tanggal BETWEEN '$mulai' AND '$dari' "
                                );
                                $gji = $db->fetch_custom_single(
                                    "Select * from  t_gaji where id_pegawai='$idpp' "
                                );
                                $over = $db->fetch_custom_single(
                                    "Select sum(overtime) as ovrtm from  t_presensi where id_pegawai='$idpp' and sts_ajukan='O' AND tanggal BETWEEN '$mulai' AND '$dari'    "
                                );
                                ...
                                $teknisi1 = $db->fetch_custom_single(
                                    ...
                                    AND sts_hapus='N' and p.tgl BETWEEN '$mulai' AND '$dari'  and p.tek1='$idpp';"
                                ...
                                $teknisi2 = $db->fetch_custom_single(
                                    ...
                                    AND sts_hapus='N' and p.tgl BETWEEN '$mulai' AND '$dari'  and p.tek2='$idpp'"
                                ...
                                $teknisi3 = $db->fetch_custom_single(
                                    ...
                                    AND sts_hapus='N' and p.tgl BETWEEN '$mulai' AND '$dari'  and p.tek3='$idpp'"
                                ...
                                $teknisi4 = $db->fetch_custom_single(
                                    ...
                                    AND sts_hapus='N' and p.tgl BETWEEN '$mulai' AND '$dari'  and p.tek4='$idpp' "
                                );
                                $ins =
                                    $teknisi1->jmlh +
                                    $teknisi2->jmlh +
                                ...
                                //         strtotime(date('28-m-Y') . '- 1 month')
                                //      );
                                $awal_cuti = date('d-m-Y', strtotime($mulai));
                                $akhir_cuti = date('d-m-Y', strtotime($dari));
                                ...
                                $tgl1 = new DateTime($mulai);
                                $tgl2 = new DateTime($dari);
                        ...
                        <tbody>
                            ...
                            $dtb1 = $pg->myquery(
                                "select*from sys_users as a, t_histori_gaji as b where a.id=b.id_pegawai
                                  $search order by b.tgl_gajian DESC",
                                $limit
                            );
                            $no = 1;
                            $no = $pg->Num($limit);
