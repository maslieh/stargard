        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                <table class="table table-striped">
                    <?php
                    $rp = $db->fetch_custom_single(
                        "SELECT * FROM t_transaksi as a, `t_paket` as c ,t_tipe as d,sys_users as e
                            where a.id_teknisi=c.id and d.id=c.tipe  and a.id_sales=e.id and a.waranti='$tek'"
                    );
                    ...
                    <tr>
                        ...
                        <td><b>:<em> <?= ucwords(
                            terbilang($rp->booking)
                        ) ?> Rupiah</em></b> </td>
                    </tr>
                    <tr>
                        <td width="150">Untuk Pembayaran</td>
                        <td><b>: <?= ucwords($rp->nama) ?> -
                                (<?= ucwords($sts) ?>)</b> </td>
                    </tr>
                    <tr>
                        <td width="150">Kendaraan</td>
                        <td><b>: <?= ucwords($rp->jns_kendaraan) ?></b> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><b>: <?= ucwords($rp->first_name) ?> <?= ucwords(
     $rp->last_name
 ) ?></b> </td>
                    </tr>
                </table>
