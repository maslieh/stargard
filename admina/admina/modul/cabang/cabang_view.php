...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Cabang List</li>
    </ol>
</section>
...
<section class="content">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $dtb = $pg->myquery(
                                "select id,nama,deskripsi from t_cabang  $search",
                                $limit
                            );
                            $no = $pg->Num($limit);
                            $count = $pg->Num($limit);
    ...
    <a href="<?= base_index() ?>cabang/tambah" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
