        ...
        <div class="col-lg-12">
            <div class="box box-solid box-primary">
                <div class="box-header">
                    <h3 class="box-title">Tambah tipe</h3>
                ...
                <div class="box-body">
                    <form id="input" method="post" class="form-horizontal"
                        action="<?= base_admin() ?>modul/tipe/tipe_action.php?act=in">
                        <div class="form-group ">
                            <label for="Level User" class="control-label col-lg-4">Nama tipe</label>
                            <div class="col-lg-4">
                                <input type="text" id="level" name="level" placeholder="Nama tipe" class="form-control "
                                    required>
                            </div>
                        </div><!-- /.form-group -->
