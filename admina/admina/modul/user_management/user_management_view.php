                ...
                <section class="content">
                                ...
                                <div class="box-body table-responsive">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $dtb = $pg->myquery(
                                                "select nama,sys_users.aktif,sys_users.username,
                                             sys_users.email,sys_group_users.level,sys_users.id,
                                             nama from sys_users  inner join sys_group_users on 
                                             sys_users.id_group=sys_group_users.id left join t_cabang on 
                                             sys_users.kode_jurusan=t_cabang.id $search",
                                                $limit
                                            );
                                            $no = $pg->Num($limit);
                                            $count = $pg->Num($limit);
                                            ...
                                            foreach (
                                                ...
                                                <td><?= $isi->aktif ?></td>
                                                <td>
                                                    <a href="<?= base_index() ?>user-management/detail/<?= $isi->id ?>"
                                                        class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                    <a href="<?= base_index() ?>user-management/edit/<?= $isi->id ?>"
                                                        class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                                    <a href="<?= base_index() ?>user-management/reset/<?= $isi->id ?>"
                                                        class="btn btn-danger">Reset</a>
                                                    <button class="btn btn-danger hapus"
                                                        data-uri="<?= base_admin() ?>modul/user_management/user_management_action.php"
                    ...
                    <a href="<?= base_index() ?>user-management/tambah" class="btn btn-primary"><i
