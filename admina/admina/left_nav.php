    ...
    $_SESSION['id_user']
         ...
         /.search form -->
           ...
           <ul class="sidebar-menu">
               ...
               <li class="treeview <?= $path_url == 'user-management' ||
               $path_url == 'page' ||
               $path_url == 'modul' ||
               $path_url == 'menu-management' ||
               $path_url == 'group-user'
                   ? 'active'
                   : '' ?>">
                   <a href="#">
                   ...
                   <ul class="treeview-menu">
                       ...
                       <li class="<?= $path_url == 'menu-management'
                           ? 'active'
                           : '' ?>">
                       ...
                       <li class="<?= $path_url == 'user-management'
                           ? 'active'
                           : '' ?>">
               ...
               $result = $db->query(
                   "select sys_menu.*,sys_menu_role.read_act,sys_menu_role.insert_act,sys_menu_role.update_act,
                   sys_menu_role.delete_act,sys_menu_role.group_id from sys_menu
                    left join sys_menu_role on sys_menu.id=sys_menu_role.id_menu
                    where sys_menu_role.group_id=? and sys_menu_role.read_act=? and tampil=? ORDER BY parent, urutan_menu",
                   [
