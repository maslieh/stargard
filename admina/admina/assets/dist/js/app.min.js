...
($.AdminLTE = {}),
  ...
  $(function () {
    ...
    $.AdminLTE.layout.activate(),
      ...
      a.navbarMenuSlimscroll &&
        ...
        $(".navbar .menu")
          .slimscroll({ height: "200px", alwaysVisible: !1, size: "3px" })
          .css("width", "100%"),
      ...
      a.directChat.enable &&
        $(a.directChat.contactToggleSelector).click(function () {
  ...
  ($.AdminLTE.boxWidget = {
    ...
    collapse: function (a) {
      ...
      b.hasClass("collapsed-box")
        ? (a.children(".fa-plus").removeClass("fa-plus").addClass("fa-minus"),
          c.slideDown(300, function () {
            b.removeClass("collapsed-box");
          }))
        : (a.children(".fa-minus").removeClass("fa-minus").addClass("fa-plus"),
  ...
  (function (a) {
    a.fn.todolist = function (b) {
      var c = a.extend(
        { onCheck: function () {}, onUncheck: function () {} },
        b
      );
      return this.each(function () {
