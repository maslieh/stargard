 ...
 <footer class="main-footer">
     ...
     <span id="printPageButton1">
         <strong>Copyright &copy; 2014-2015 <a href="#">SyntaxError</a>.</strong> All rights
         reserved.
     </span>
 </footer>
 ...
 <script src="<?= base_admin() ?>assets/plugins/chartjs/jquery.flot.categories.js" type="text/javascript"></script>

 <script src="<?= base_admin() ?>assets/plugins/chartjs/jquery.flot.js" type="text/javascript"></script>
 <script src="<?= base_admin() ?>assets/plugins/chartjs/jquery.flot.pie.js" type="text/javascript"></script>
 <script src="<?= base_admin() ?>assets/plugins/chartjs/jquery.flot.resize.js" type="text/javascript"></script>
 <?php if (
     $path['call_parts'][1] == 'index.php' ||
     $path['call_parts'][1] == ''
 ) { ?>
 ...
 <!-- jvectormap -->
 <script src="<?= base_admin() ?>assets/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js" type="text/javascript">
 </script>
 <script src="<?= base_admin() ?>assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript">
 </script>
 <!-- daterangepicker -->
 ...
 <?php } elseif (
     $path['call_parts'][1] !== '' &&
     array_key_exists(2, $path['call_parts']) == false
 ) { ?>
 <!--list table assets -->
 <!-- Bootstrap 3.3.2 JS -->
 <script src="<?= base_admin() ?>assets/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
...
$(function() {
 ...
 <?php } elseif (
     $path['call_parts'][1] !== '' &&
     array_key_exists(2, $path['call_parts']) == true
 ) { ?>
 <!--form asset -->
 <!-- jQuery 2.1.3 -->
...
$('textarea.editbox').ckeditor({
 ...
 <link rel="stylesheet" type="text/css" href="<?= base_admin() ?>assets/plugins/fancybox/jquery.fancybox.css?v=2.1.5"
     media="screen" />
 <script type="text/javascript">
...
function add_multi(val) {
 ...
 <!-- Bootstrap WYSIHTML5 -->
 <script src="<?= base_admin() ?>assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"
